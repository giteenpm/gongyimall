...
public class CookieUtil {
    ...
    public static String checkMallAdmin(HttpServletRequest request) {
        String mallAdminInfo = CookieUtil.getCookieValue(request, "mallAdminInfo", true);
        try {
           String content= AESUtil.decrypt(mallAdminInfo,"key_value_length");
            if (StringUtils.isNotBlank(content)){
               return "success";
            }
        } catch (Exception e) {
